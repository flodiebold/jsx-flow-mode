...
** DONE run all tests in file, list test results in results buffer
   CLOSED: [2017-04-27 Do 19:07]
** DONE update existing results from the same test in results buffer
   CLOSED: [2017-04-27 Do 19:11]
** TODO give short status on suite level
** TODO run all tests in project
** TODO make test results collapsible
** TODO remove test results when the tests don't exist anymore
** TODO show error messages and stacktraces in results buffer
...
** TODO rerun tests from results buffer
** TODO rerun failed tests
** TODO fix stacktraces
