...
** TODO complete module paths in require / import
** TODO fuzzy completion
* TODO handle JSX member expressions
i.e. <Foo.Bar />
...
* performance
** TODO cancel old parse process when the buffer is invalidated before it's done
* bugs
...
** TODO clean up coverage props before setting new ones
